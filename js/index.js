var mContainer = document.getElementById('three-container');
...
function initAudio(playUrl) {
  ...
  mAudioElement.src = playUrl;

  mAnalyser = new SpectrumAnalyzer(mPathLength * 0.5, 0.50);
...
function initTHREE() {
  ...
  mLight = new THREE.PointLight(0xACEACE, 1, 1200, 2);
